...
import sys
import os
img_path = os.path.abspath("home/ashwin/Desktop/Semester 3/Object Retrieval from Video/Implementation/Datasets/CNN2h Dataset/temp/Frame000004.jpg")
if __name__ == '__main__':
    print(__doc__)

    model = sys.argv[1]
    im = cv.imread("Frame000027.jpg")
